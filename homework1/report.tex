...
\maketitle
\begin{abstract}
  This article shows some example in using {\LaTeX}. We recommend all of you write the homework using \LaTeX.
\end{abstract}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\linewidth]{result/homework1_1.jpg}
    \caption{result}
\end{figure}

\section{不使用for的双线性插值}

能力有限，只能实现普通的双线性插值，详情见博客

\href{https://github.com/3017218062/Image-Super-Resolution}
